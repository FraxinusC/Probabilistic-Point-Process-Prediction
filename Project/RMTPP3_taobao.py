...
class RMTPP3(TorchBaseModel, Registrable):
    @Registrable.register("RMTPP3")  
    def __init__(self, model_config):
        super(RMTPP3, self).__init__(model_config)
    ...
    def evolve_and_get_intentsity(self, right_hiddens_BNH, dts_BNG):
        ...
        past_influence_BNGM = mean + eps * std
...
def main():
    ...
    parser.add_argument('--experiment_id', type=str, required=False, default='RMTPP3_gen_taobao',
